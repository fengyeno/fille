...
class HxController extends Controller{
	 ...
	 * 环信-服务器端REST API
	 */
	private $client_id = 'YXA6ma_wEO4xEeSnuUs0xVEHEg';
	private $client_secret = 'YXA68QpOA6mDW65lnU_2deMsVRBIL90';
	private $org_name = 'f2o';
	private $app_name = '摄交圈';
	private $url = 'https://a1.easemob.com/bizqd/f2o/';
	/**
	 * 开放注册模式
	 *
