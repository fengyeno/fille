...
<table class="procut_item" border="0" cellpadding="4">
  <tr>
    ...
    <input class="dw_button" type="submit" name="submitbutt" value="Buy (0.01 <?php echo $PayPalCurrencyCode; ?>)" />
    </form>
    </td>
  </tr>
</table>
...
<table class="procut_item" border="0" cellpadding="4">
  <tr>
	...
	<input type="hidden" name="itemprice" value="0.01" /> Quantity : <select name="itemQty"><option value="1">1</option><option value="2">2</option><option value="3">3</option></select>
    <input class="dw_button" type="submit" name="submitbutt" value="Buy (0.01 <?php echo $PayPalCurrencyCode; ?>)" />
    </form></td>
  </tr>
</table>
