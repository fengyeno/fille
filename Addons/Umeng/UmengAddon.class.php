 ...
 */
class UmengAddon extends Addon{
    ...
    public $addon_path = './Addons/Umeng/';
    public $menu = array(
        'addons' => 'Umeng',
        'hook' => 'UmengAdmin',
        'status'=>1
    ...
    public function uninstall()
    {
        ...
        M('hooks')->where(array('addons'=>'Umeng'))->delete();
        return true;
    }


    public function UmengAdmin(){
        $addons=I('_addons');
        $current=($addons=='Umeng'||$addons=='umeng'?'current':'');
        echo '<li class="'.$current.'"><a href="'.addons_url("Umeng://Umeng/index").'">'.$this->info["title"].'</a></li>';
    }
